...
import javax.swing.event.*; //Listeners
import java.awt.*;          //Draw
...
/*
 * This class handles and paints the game. Calls on Board for implementation.
 */ 
...
public class Minesweeper extends JFrame{
  ...
  JLabel timeCount;
  private JButton resetFace;
  javax.swing.Timer timeCounter;
  int time;
  //Music
  private URL urlForAudio = getClass().getResource("bloop.wav");
  private AudioClip audioClip = Applet.newAudioClip(urlForAudio);

  public Minesweeper(){
    mineSweeper = new Board();
  } 
  public Minesweeper(int theCols, int theRows){
    mineSweeper = new Board(theCols, theRows);
  }
  ...
  public static void usage(int typeOfErr){
    //notNum(1), notEnoughArgs(2), notGoodSize(3) 
    System.out.println("usage: java Minesweeper [number of rows] [number of columns]");
    if(typeOfErr == 1){
      System.out.println("       Please enter valid numbers");
    }
    if(typeOfErr == 2){
      System.out.println("       Please enter 0 or 2 arguments.");
    }
    if(typeOfErr == 3){
      System.out.println("       Please enter a valid board size (minimum 3 x 3).");
    }
    System.exit(1);
  }
  public static void main (String[] args){
    ...
    //used to hold command line args
    int arg0 = 0;      
    int arg1 = 0;
    int arg2 = 0;

    //errorflag noError(0), notNum(1), notEnoughArgs(2), notGoodSize(3)
    int errFlag = 0; 
    ...
    //right # of args
      ...
      //2x1 and 1x2
      if(((arg0 == 2) & (arg1 == 1)) | ((arg0 == 1) & (arg1 == 2))){
        errFlag = 3;
        usage(errFlag);
      } 
      //2x2
      ...
      //parse successful
      board = new Minesweeper(arg0, arg1);
      errFlag = 0;
    }
    //any number of args besides 0 or 2
    else{
      errFlag = 2;
      usage(errFlag);
    }
  ...
  public class MineCell extends JPanel
  {
    ...
    { 
      ...
      repaint();
    } //end minecell inner class


    //----------------------------------------------------------------
    //---------------------Listener Inner Class--____-----------------
    //----------------------------------------------------------------
    /*
