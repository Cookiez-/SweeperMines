...
/*
 * This class handles the implementation. Called by minesweeper
 */
public class Board{ 
  ...
  /** 
   * 2-args constructor Creates a new board with input
   */ 
  public Board(int inColumns, int inRows){
    this.columns = inColumns;
    this.rows = inRows;
    this.bombCount = inColumns*inRows/4;     //calculates bomb based on board size
